...
class GLApp
{
  public:
    ...
    ImguizmoDialog* GetImguizmoDlg() const { return imguizmoDlg.get(); }

    ImguiparamsDialog* GetImguiparamsDlg() const { return imguiparamsDlg.get(); }
  ...
  private:
    ...
    std::unique_ptr<ImguizmoDialog> imguizmoDlg;
    std::unique_ptr<ImguiparamsDialog> imguiparamsDlg;
};
